...
public class DataInitializer implements CommandLineRunner {
    ...
    private void initializeHomeData() {
        ...
        stats.put("happyPatients", 5000);
        stats.put("doctors", 5);
        stats.put("departments", 10);
        home.setStats(stats);
    ...
    private void initializeAboutData() {
        ...
        about.setMainDescription("For over 10 years, we have been providing exceptional healthcare services to our community...");
        ...
        about.setHistory("Founded in 2015 by Dr. Habtamu Alemye, our clinic has grown to become a trusted healthcare provider...");
        ...
        stats.put("founded", 2015);
        stats.put("patientsPerYear", 5000);
        stats.put("surgeries", 100);
        stats.put("doctors", 5);
        stats.put("nurses", 10);
